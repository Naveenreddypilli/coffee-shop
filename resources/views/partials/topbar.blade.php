<nav class="sb-topnav navbar navbar-expand navbar-light bg-light">
  ...
  <a class="navbar-brand ps-3" href="/home">coffeeshop</i> </a>
  ...
  <ul class="navbar-nav ms-auto ms-md-0 me-1 me-lg-2" style="margin-right: 0;">
    <li class="nav-item dropdown">
      <a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown"
        aria-expanded="false"><img width="40px" height="40px" class="fas fa-user"></a>
          <!-- src="C:\Users\navee\OneDrive\Desktop\3106773.png"></a> -->
